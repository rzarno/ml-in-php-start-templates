...
class CaptchaModelTraining implements StageInterface
{
    ...
    public function __invoke($payload)
    {
        ...
        $this->trainModel(
            $payload->getModel(),
            $payload->getNormalizedTrainX(),
            $payload->getNormalizedTrainY(),
            $payload->getNormalizedTestX(),
            $payload->getNormalizedTestY(),
